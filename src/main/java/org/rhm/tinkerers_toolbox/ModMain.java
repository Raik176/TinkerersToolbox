...
public class ModMain implements ModInitializer {
    ...
    public static final ItemGroup ITEM_GROUP = FabricItemGroup.builder().icon(() -> new ItemStack(ModBlocks.TINKERERS_BENCH)).displayName(Text.translatable("itemGroup." + MOD_ID)).build();
